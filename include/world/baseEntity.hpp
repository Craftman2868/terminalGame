...
#define GRAVITY_ENABLED false
#define GRAVITY ((double) 1 / 50)
#define MAX_SPEED (double) 0.2

#define DEFAULT_ACCEL 0.003
...
public:
    ...
    void setDirection(double yaw, double pitch) { setYaw(yaw); setPitch(pitch); }
